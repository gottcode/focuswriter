...
if [ ! -e "${lodict}.tar.xz" ]; then
	curl -s -O -L "https://download.documentfoundation.org/libreoffice/src/25.8.4/${lodict}.tar.xz"
	echo ' DONE'
else
	echo ' SKIPPED'
fi
...
echo -n ' mr'
cp -a $lofiles/mr_IN/mr_IN.aff dicts/mr.aff
cp -a $lofiles/mr_IN/mr_IN.dic dicts/mr.dic
echo -n ' nl'
